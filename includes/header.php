                ...
                <div class="container">
                    <h1>
                        <a class="navbar-brand font-weight-bold font-italic" href="index.php">
                            <span style="color: red;">Rakt</span><span style="color: white;">Nest</span>
                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        ...
                        <a href="admin/index.php" class="login-button ml-lg-5 mt-lg-0 mt-4 mb-lg-0 mb-3" >
                            <i class="fas fa-sign-in-alt mr-2"></i>Admin</a><?php } ?>
                    </div>
                </div>
            </nav>
        </div>
