      ...
      <div class="container py-xl-5 py-lg-3">
        <div class="row">
          <div class="col-md-4 w3l-footer">
            ...
            <p>Raktnest is a platform that unites blood donors and recipients, making it easy to 
              connect during emergencies. With every donation, we move closer to a world where no life is lost  due to 
              blood shortage. Because every drop of blood counts.
            </p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">©  RaktNest
          </p>
        </div>
      </div>
    </div>
