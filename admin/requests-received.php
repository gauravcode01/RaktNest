...
<h3> Blood Required Requests</h3>
<hr />
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading"><b style="color:black;">Blood Info</b></div>
                 ...
                 <td><?php  echo htmlentities($row->Message);?> 
                                            ...
                                            <td>
                                              <?php  echo htmlentities($row->ApplyDate);?>  
											         ...
											         <td>
                <!-- Reject -->
                <a href="request-action.php?id=<?php echo $row->reqid; ?>&action=reject" 
                   onclick="return confirm('Are you sure you want to reject this request?')" 
                   style="color:red; font-size:20px;">❌</a>

                <!-- Accept -->
                <a href="request-action.php?id=<?php echo $row->reqid; ?>&action=accept" 
                   style="color:green; font-size:20px; margin-left:10px;">✅</a>
            </td>
                                        </tr>
                                  <?php $cnt=$cnt+1;}}?>+
