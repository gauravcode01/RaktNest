...
<head>
	...
	<title>RaktNest| Donor List  </title>
...
$sql="SELECT tblbloodrequirer.BloodDonarID,tblbloodrequirer.name,
tblbloodrequirer.EmailId,tblbloodrequirer.ContactNumber,
tblbloodrequirer.BloodRequirefor,tblbloodrequirer.Message,
tblbloodrequirer.ApplyDate,tblblooddonars.id as donid,
tblblooddonars.FullName,tblblooddonars.MobileNumber,
tblblooddonars.BloodGroup 
from tblbloodrequirer 
join tblblooddonars on tblblooddonars.id=tblbloodrequirer.BloodDonarID 
where tblblooddonars.FullName like '%$sdata%' 
   || tblblooddonars.MobileNumber like '%$sdata%' 
   || tblbloodrequirer.name like '%$sdata%' 
   || tblbloodrequirer.ContactNumber like '%$sdata%' 
   || tblblooddonars.BloodGroup like '%$sdata%'";
...
{               ?>
                                        ...
                                        <td><?php  echo htmlentities($row->name);?></td>
										  ...
										  <td><?php echo htmlentities($row->Message);?></td>                  </td>
