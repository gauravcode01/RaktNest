...
<head>
	<title>RaktNest | Home Page</title>
...
{ ?>
				<div class="col-md-4 pricing" style="margin-top:2%;">
					...
					<div class="price-bottom p-4">
						...
						<a class="btn btn-primary" style="color:#fff" href="sign-up.php?cid=<?php echo $result->id;?>">Request</a>
					</div>
				</div><?php }} ?>
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2" style="color:black;">blood group of any human being will mainly fall in any one of the following groups..</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
...
<li><b>A positive or A negative</li></b>
<li><b>B positive or B negative</li></b>
<li><b>O positive or O negative</li></b>
<li><b>AB positive or AB negative.</li></b>
                </ul>
				<br>
        ...
        <div class="row mb-4">
            <div class="col-md-8">
            <h4 style="padding-top: 30px;"><b>UNIVERSAL DONORS AND RECIPIENTS</h4></b>
                <p style="color:black;">
